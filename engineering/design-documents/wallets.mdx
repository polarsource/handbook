...
It's likely that some Customers will want to have a refund for a top-up they made. It's a bit tricky here as the Customer may have already consumed some of the credits. Same thing for disputes.
...
<OpenQuestion>
  ...
  top-ups, even if they consumed a lot of credits. We could consider a mechanism
  where the merchant could "block" a Customer from making further top-ups.
</OpenQuestion>
