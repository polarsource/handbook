...
| ----------- | -------------- | ----------------------------------------------------------------------------------------------- |
| **Public** | 🟢 Public      | Customer-facing issues: bugs, small feature requests, and support tickets, and Roadmap           |
...
| `discussion`            | Discussion of the feature request/idea                            |
...
**Repositories:**
- Most issues will be public under the `polarsource/polar` repository and with the `#polar-team` label.
